...
def main():
    ...
    parser.add_argument('--endpoint', default=os.environ.get('ARTIFACT_API_URL'),
                        required=not bool(os.environ.get('ARTIFACT_API_URL')))
    parser.add_argument('--profile', help='AWS profile; omit to use the default credential chain')
    parser.add_argument('--region', default=os.environ.get('ARTIFACT_API_REGION', 'us-west-2'))
    ...
    parser.add_argument('--result', default='ntpc-import-result.json')
